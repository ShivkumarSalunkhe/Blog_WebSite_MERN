...
export const DetailsPages = () => {
  ...
  useEffect(() => {
    const getPost = async () => {
      const res = await axios.get("https://blog-website-mern.onrender.com/posts/" + path)
      console.log(res)
      //setp 2
      setPost(res.data)
      //setp 4
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://blog-website-mern.onrender.com/posts/${post._id}`, { data: { username: user.username } })
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(`https://blog-website-mern.onrender.com/posts/${post._id}`, { username: user.username, title, desc })
